package org.gaosheng.util.xls.reader;
...
//	public abstract void optRows(int curRow, List<String> rowlist) throws SQLException ;
	...
	public void processRecord(Record record) {
		...
		case NumberRecord.sid:
			...
			if(DateUtil.isADateFormat(formatListener.getFormatIndex(numrec),formatListener.getFormatString(numrec)) && DateUtil.isValidExcelDate(cellVlaue)) {
